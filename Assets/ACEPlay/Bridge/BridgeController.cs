...
namespace ACEPlay.Bridge
{
    ...
    public class BridgeController : MonoBehaviour
    {
        ...
        public void ShowInterstitial(string placement, UnityEvent onClosed, UnityEvent onDone = null, bool skipCheckCappingTime = false)
        {
            Debug.LogError("=====Interstitial Show success!=====");
            onDone?.Invoke();
            onClosed?.Invoke();
        ...
        {
            Debug.Log("=====Follow Twitter Success=====");
            if (onFollowTwitter != null) onFollowTwitter.Invoke();
        }
        public void FollowTikTok(UnityEvent onFolllowTikTok)
        {
            Debug.Log("=====Follow TikTok Success=====");
            if (onFolllowTikTok != null) onFolllowTikTok.Invoke();
        }
        public void FollowFacebook(UnityEvent onFolllowFacebook)
        {
            Debug.Log("=====Follow Facebook Success=====");
            if (onFolllowFacebook != null) onFolllowFacebook.Invoke();
        }
        public void FollowInstagram(UnityEvent onFolllowInstagram)
        {
            Debug.Log("=====Follow Instagram Success=====");
